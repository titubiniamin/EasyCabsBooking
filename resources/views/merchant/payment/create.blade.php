                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Payment Request Create
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="form-group breadcrumb-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('merchant.payment-request.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square mr-1">
        ...
        <section>
            <div class="row">
                <div class="col-xl-6 col-md-4 col-sm-4">
                    <form action="{{route('merchant.payment-request.store')}}" method="POST" class="">
                        @csrf
                        <button class="btn" type="submit">
                            <div class="card" style="background-color:#0744176b;">
                                <div class="card-body">
                                    ...
                                    <h4 style="color: white;padding:10px;">Sent Payment Request</h4>
