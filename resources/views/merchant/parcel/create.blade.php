...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <section id="basic-input">
            <!-- <form action="{{ route('merchant.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <form action="{{route('merchant.parcel.store')}}" method="POST" class="">
                                ...
                                <div class="row">
                                    <div class="form-group required col-md-4">
                                        <label class="control-label" for="city_type_id">Delivery Location <span style="color: red;">*</span></label>
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label class="control-label" for="area_id">Delivery Area <span style="color: red;">*</span></label>
                                    ...
                                    <div class="form-group required col-md-4">
                                        <label class="control-label" for="parcel_type_id">Percel Type <span style="color: red;">*</span></label>
                                    ...
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <div class="form-group required">
                                            <label class="control-label" for="weight_range_id">Weight <span style="color: red;">*</span></label>
                                    ...
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <div class="form-group required">
                                            <label for="collection_amount" class="control-label">Collection Amount <span style="color: red;">*</span></label>
                                            <input type="text" class="form-control" id="collection_amount" name="collection_amount" v-model="collection_amount" placeholder="Collection Amount" autocomplete="off" v-bind:readonly="isReadOnly">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                    ...
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <div class="form-group required">
                                            ...
                                            <input type="date" id="added_date" name="added_date" class="form-control" placeholder="YYYY-MM-DD">
                                        </div>
                                    </div>

                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <div class="form-group required">
                                            <label for="customer_mobile" class="control-label">Customer Mobile Number <span style="color: red;">*</span></label>
                                    ...
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <div class="form-group required">
                                            ...
                                            <textarea class="form-control" id="customer_address" name="customer_address" placeholder="Enter Address" rows="2" required></textarea>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-12 mb-1">
                                        <div class="form-group">
                                            <label for="note">Note</label>
                                            <textarea class="form-control" id="note" name="note" placeholder="Enter Note" rows="2"></textarea>
