        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">
                    <a class="dropdown-item" href="{{url('localization/en')}}"><i class="flag-icon flag-icon-us"></i> English</a>
                    <a class="dropdown-item" href="{{url('localization/bn')}}"><i class="flag-icon flag-icon-bd"></i> বাংলা</a>
                </div>
            </li>
            ...
            <li class="nav-item d-none d-lg-block">
                <a class="nav-link text-danger" href="{{ route('admin.merchant.index') }}">
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">{{ Auth::guard('merchant')->user()->name }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="{{ url('/merchant/settings') }}"><i class="mr-50" data-feather="settings"></i> Settings</a>
                    <a class="dropdown-item" href="{{ route('merchant.logout') }}" onclick="event.preventDefault();
