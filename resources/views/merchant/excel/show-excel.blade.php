    ...
    <div class="content-body">
        ...
        <section id="basic-input">
            <div class="row justify-content-center" id="vue_app">
                <form action="{{route('merchant.parcel.merchantExcelStore')}}" method="POST" class="">
                    <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 ">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="parcels[{{$index}}][collection_amount]" value="{{$data1['collection_amount']}}" required>
                                        </div>
                                    </div>
