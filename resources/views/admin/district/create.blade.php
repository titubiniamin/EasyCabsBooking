                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a>
                            ...
                            <li class="breadcrumb-item active">district Create
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="form-group breadcrumb-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('admin.district.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square mr-1">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">District Create</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.district.store')}}" method="POST" class="">
                                @csrf
                                <div class="row">
