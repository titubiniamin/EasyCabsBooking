                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a>
                            ...
                            <li class="breadcrumb-item active">Upazila Edit
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="form-group breadcrumb-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('admin.upazila.index')}}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-square mr-1">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Upazila Edit</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.upazila.update',$model)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control form-control-sm" id="division_id" name="division_id" v-model="division_id" @change="fetch_district()">
                                            ...
                                            <option value="{{ $list->id }}" {{ $list->id == $model->district->division_id ? 'selected' : '' }}> {{ $list->name }}({{ $list->bn_name }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="name" name="name" value="{{$model->name}}" placeholder="Enter Name">
                                    </div>
    ...
    $(document).ready(function() {
        var vue = new Vue({
            ...
            data: {
                ...
                division_id: '{{$model->district->division_id}}',
