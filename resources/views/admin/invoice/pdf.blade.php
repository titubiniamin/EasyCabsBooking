...
<body>
    ...
    <table style="border: 2px solid #fff;">
        <tr>
            ...
            <td class="tc bb-none">
                <p style="font-size: 12px;" class="tc"><b>Created By:</b> {{$invoice->invoice->name??''}}</p>
            </td>
            <td class="tc bb-none">
                <p style="font-size: 12px;" class="tc"><b>Created Time: </b> {{$invoice->created_at->format('F j, Y, g:i a')}}</p>
            </td>
            <td class="tr bb-none">
                @php
    ...
    <table>
        <tr>
            <td><b>Merchant Name:</b> {{$invoice->prepare_for->name}}</td>
            <td><b>Merchant Mobile:</b> {{$invoice->prepare_for->mobile}}</td>
    ...
    <table class="table">
        ...
        <tr style="border: 2px solid green;">
            <td class="pr-1" colspan="8">Total</td>
