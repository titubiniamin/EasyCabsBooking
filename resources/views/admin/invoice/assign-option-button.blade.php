<div class="button-group">
     <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-{{$parcelId}}">Assign A Rider</button>
</div>

<div class="modal fade text-left" id="modal-{{$parcelId}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin.parcel.rider-assign', $parcelId)}}" method="POST">
                @csrf
                @method('put')
