                    ...
                    <div class="card ">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <h4 class="invoice-title text-right">Invoice <span class="invoice-number">#{{$invoice->invoice_number}}</span>
                                    </h4>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-1">
                                            <span class="font-weight-bold">{{$item->parcel->parcelCollection->amount}}</span>
                                        </td>
                                        <td class="py-1">
