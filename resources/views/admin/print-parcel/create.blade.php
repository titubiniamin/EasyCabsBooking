...
<div class="content-wrapper">
    ...
    @endphp
    <x-bread-crumb-component title='Print Parcel' :links="$links" />
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="head-label">
                                <h4 class="mb-0">Print Parcel</h4>
                            </div>
                            <div class="dt-action-buttons text-right">
                                <div class="dt-buttons d-inline-flex">
                                    <a href="{{ route('admin.print-parcels.index') }}" class="btn btn-primary waves-effect waves-float waves-light mr-2" target="_blank">Print Sheet List</a>
                                    <a href="{{ route('admin.search-parcel') }}" class="btn btn-info waves-effect waves-float waves-light" target="_blank">Search Parcel</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
