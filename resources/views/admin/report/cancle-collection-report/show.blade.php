...
@endpush
@section('title', 'Cancle Collection Report')
@section('content')
    <div class="content-wrapper">
        ...
        @endphp
        <x-bread-crumb-component title='Cancle Collection Report' :links="$links" />
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Cancle Collection Report</h4>
                            </div>
                            <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#search_button').on('click', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('admin.cancle-collection-report.search-result') }}",
                    data: {
                        month: month,
                        year: year,
                    },
