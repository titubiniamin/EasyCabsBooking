                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" id="daterange" class="form-control flatpickr-range"
                                                   name="daterange" placeholder="YYYY-MM-DD to YYYY-MM-DD"
                                                   autocomplete="off">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            ...
                                            <button
                                                ...
                                                type="button" id="search_button">Search
                                            </button>
                                        </div>
                                    </div>
                                </form>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#search_button').on('click', function () {
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('admin.parcel-summary-two-in-rider-wise-search') }}",
                    data: {
                        rider_id: rider_id,
                        dateRange: daterange,
                    },
    ...
    <script>
        $(document).ready(function () {
            var table = $('#dataTable').dataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: '{!! route('admin.parcel-summary-two-in-rider-wise',['status'=>request('status')]) !!}',
                columns: [
                    {
