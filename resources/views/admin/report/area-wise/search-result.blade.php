<div class="card">
    ...
    <form action="{{route('admin.print-parcel-area-wise')}}" method="POST" class="" target="_blank">
        @csrf
        <div class="card-body">
            @if(count($parcels) > 0)
            <table class="table">
                ...
                <tbody>
                    ...
                    @endforeach
                    <input type="hidden" name="area_id" value="{{ $parcelData->area_id }}" id="search_area_id">
                </tbody>
            </table>
