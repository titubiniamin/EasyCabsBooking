                    ...
                    <div class="card">
                        <div class="card-header ">
                            <div class="head-label">
                                <h4 class="mb-0"> Due Details for {{ucfirst($rider->name)}}</h4>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#dataTable').dataTable({
                ...
                serverSide: true,
                processing: true,
                ajax: '{{route('admin.merchant-wise-due.rider.show', ['rider_id'=>$rider->id, 'merchant_id'=>$merchant_id, 'date_range'=>$date_range])}}',
                columns: [
                    {
                        data: "DT_RowIndex",
                        title: "SL",
