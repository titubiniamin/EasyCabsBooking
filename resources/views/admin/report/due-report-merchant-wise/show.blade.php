...
@endpush
@section('title', 'Due Report Merchant Wise')
@section('content')
    <div class="content-wrapper">
        @php
            $links = [
                'Home'=>route('admin.dashboard'),
                'Due Report Merchant Wise'=>''
            ]
        @endphp
        <x-bread-crumb-component title='Due Report Merchant Wise' :links="$links"/>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Due Report Merchant Wise</h4>
                            </div>
                            <div class="card-body">
    ...
    <script>
        $(document).ready(function () {
            $('#search_button').on('click', function () {
                ...
                if(merchant_id == null){
                    alert('Insert a merchant right now')
                }else {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.merchant-wise-due-search') }}",
                        data: {
