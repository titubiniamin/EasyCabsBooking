                            ...
                            <form action="" method="POST" class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select class="select2 form-control form-control-sm" name="status" id="status">
                                            <option value="all" >All</option>
                                            <option value="wait_for_pickup" >Wait For Pickup</option>
...
<script>
    $(document).ready(function() {
        $('#search_button').on('click', function() {
            ...
            $.ajax({
                type: "GET",
                url: "{{ route('admin.date-wise-parcel-search') }}",
                data: {
