                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.parcel.update',$parcel->id)}}" method="POST" class="">
                                @method('put')
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-4 col-12 mb-1">
                                        <div class="form-group required">
                                            ...
                                            <input type="date" id="added_date" name="added_date" class="form-control" placeholder="YYYY-MM-DD" value="{{ $parcel->added_date}}">
                                        </div>
                                    </div>
