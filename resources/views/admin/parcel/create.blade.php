                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="invoice_id" name="invoice_id" value="{{old('invoice_id')}}" placeholder="Enter Invoice Number" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="customer_name" value="{{old('customer_name')}}" name="customer_name" placeholder="Enter Customer Name" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control " v-bind:class="isValid" id="customer_mobile" v-model="customer_mobile" @keyup="valid_mobile_nunber()" value="{{old('customer_mobile')}}" name="customer_mobile" placeholder="Enter Customer Mobile" aria-label="Username" aria-describedby="basic-addon1" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-4 col-12 mb-1">
