<div class="row">
        ...
        <div class="form-group">
            ...
            <select class="form-control form-control-sm" name="weight_range_id" id="district">
                ...
                @foreach($weightRanges as $weightRange)
                    <option value="{{$weightRange->id}}" >{{$weightRange->min_weight}} - {{$weightRange->max_weight}}</option>
                @endforeach
            </select>
    ...
    <div class="col-md-6 col-12 mb-1">
        <div class="form-group">
            ...
            <input type="number" class="form-control form-control-sm" id="delivery_charge" name="delivery_charge" placeholder="Enter delivery charge" value="{{old('delivery_charge')}}" min="1">
    ...
    <div class="col-md-6 col-12 mb-1">
        <div class="form-group">
            ...
            <input type="number" class="form-control form-control-sm" id="cod" name="cod" placeholder="Enter COD" value="{{old('cod')}}" min="0">
            @if($errors->has('cod'))
